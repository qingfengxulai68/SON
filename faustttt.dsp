...
rumbleL = no.noise * 0.1 : fi.lowpass(3, 30);
rumbleR = no.noise * 0.1 : fi.lowpass(3, 30);

// Bruit de moteur
motor_noiseL = os.osc(50) * 0.05 + os.osc(100) * 0.02;
motor_noiseR = os.osc(50) * 0.05 + os.osc(100) * 0.02;
