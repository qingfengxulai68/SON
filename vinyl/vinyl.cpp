...
struct mydsp : public dsp {
	...
	FAUST_ADDHORIZONTALSLIDER("Left Pop Trigger", fHslider2, 0.004f, 0.0f, 1.0f, 0.001f);
	FAUST_ADDHORIZONTALSLIDER("Left Scratch Trigger", fHslider3, 0.4f, 0.0f, 1.0f, 0.01f);
	FAUST_ADDHORIZONTALSLIDER("Left rumble Trigger", fHslider1, 0.04f, 0.0f, 1.0f, 0.001f);
	FAUST_ADDHORIZONTALSLIDER("Motor Noise Left Trigger", fHslider0, 0.05f, 0.0f, 1.0f, 0.001f);
	FAUST_ADDHORIZONTALSLIDER("Motor Noise Right Trigger", fHslider4, 0.05f, 0.0f, 1.0f, 0.001f);
	FAUST_ADDHORIZONTALSLIDER("Right Pop Trigger", fHslider6, 0.004f, 0.0f, 1.0f, 0.001f);
	FAUST_ADDHORIZONTALSLIDER("Right Scratch Trigger", fHslider7, 0.4f, 0.0f, 1.0f, 0.01f);
	FAUST_ADDHORIZONTALSLIDER("Right rumble Trigger", fHslider5, 0.04f, 0.0f, 1.0f, 0.001f);
	FAUST_ADDNUMENTRY("gain_left", fEntry0, 0.5f, 0.0f, 1.0f, 0.01f);
	FAUST_ADDNUMENTRY("gain_right", fEntry1, 0.5f, 0.0f, 1.0f, 0.01f);

	#define FAUST_LIST_ACTIVES(p) \
		p(HORIZONTALSLIDER, Left_Pop_Trigger, "Left Pop Trigger", fHslider2, 0.004f, 0.0f, 1.0f, 0.001f) \
		p(HORIZONTALSLIDER, Left_Scratch_Trigger, "Left Scratch Trigger", fHslider3, 0.4f, 0.0f, 1.0f, 0.01f) \
		p(HORIZONTALSLIDER, Left_rumble_Trigger, "Left rumble Trigger", fHslider1, 0.04f, 0.0f, 1.0f, 0.001f) \
		p(HORIZONTALSLIDER, Motor_Noise_Left_Trigger, "Motor Noise Left Trigger", fHslider0, 0.05f, 0.0f, 1.0f, 0.001f) \
		p(HORIZONTALSLIDER, Motor_Noise_Right_Trigger, "Motor Noise Right Trigger", fHslider4, 0.05f, 0.0f, 1.0f, 0.001f) \
		p(HORIZONTALSLIDER, Right_Pop_Trigger, "Right Pop Trigger", fHslider6, 0.004f, 0.0f, 1.0f, 0.001f) \
		p(HORIZONTALSLIDER, Right_Scratch_Trigger, "Right Scratch Trigger", fHslider7, 0.4f, 0.0f, 1.0f, 0.01f) \
		p(HORIZONTALSLIDER, Right_rumble_Trigger, "Right rumble Trigger", fHslider5, 0.04f, 0.0f, 1.0f, 0.001f) \
		p(NUMENTRY, gain_left, "gain_left", fEntry0, 0.5f, 0.0f, 1.0f, 0.01f) \
		p(NUMENTRY, gain_right, "gain_right", fEntry1, 0.5f, 0.0f, 1.0f, 0.01f) \
