...
struct mydsp : public dsp {
	...
	virtual void instanceConstants(int sample_rate) {
		...
		fConst2 = std::tan(94.24778f / fConst0);
		fConst3 = 2.0f * (1.0f - 1.0f / mydsp_faustpower2_f(fConst2));
		fConst4 = 1.0f / fConst2;
		fConst5 = (fConst4 + -1.0f) / fConst2 + 1.0f;
		fConst6 = 1.0f / ((fConst4 + 1.0f) / fConst2 + 1.0f);
		fConst7 = 1.0f - fConst4;
		fConst8 = 1.0f / (fConst4 + 1.0f);
		fConst9 = std::max<float>(0.0f, std::min<float>(2047.0f, 2e+03f * fConst0));
		iConst10 = int(fConst9);
		iConst11 = iConst10 + 1;
		fConst12 = std::floor(fConst9);
		fConst13 = fConst9 - fConst12;
		fConst14 = fConst12 + (1.0f - fConst9);
		fConst15 = 5e-05f * fConst0;
		fConst16 = 1.0f - 44.1f / fConst0;
		fConst17 = 2.0535662e-08f / fConst0;
		fConst18 = std::tan(3141.5928f / fConst0);
		fConst19 = 2.0f * (1.0f - 1.0f / mydsp_faustpower2_f(fConst18));
		fConst20 = 1.0f / fConst18;
		fConst21 = (fConst20 + -1.0f) / fConst18 + 1.0f;
		fConst22 = 1.0f / ((fConst20 + 1.0f) / fConst18 + 1.0f);
		fConst23 = 1.0f - fConst20;
		fConst24 = 1.0f / (fConst20 + 1.0f);
		fConst25 = std::exp(-(1e+01f / fConst0));
		fConst26 = 1e+02f / fConst0;
		fConst27 = std::exp(-fConst26);
		fConst28 = std::exp(-(2e+02f / fConst0));
		fConst29 = 0.6666667f * (1.0f - fConst28);
	}
	...
	virtual void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		for (int i0 = 0; i0 < count; i0 = i0 + 1) {
			...
			fVec2[0] = fTemp2;
			fRec3[0] = fConst8 * (4.656613e-10f * (fTemp2 + fVec2[1]) - fConst7 * fRec3[1]);
			fRec2[0] = fRec3[0] - fConst6 * (fConst5 * fRec2[2] + fConst3 * fRec2[1]);
			float fTemp3 = ((iTemp0) ? 0.0f : fConst1 + fRec5[1]);
			fRec5[0] = fTemp3 - std::floor(fTemp3);
			float fTemp4 = mydsp_faustpower2_f(2.0f * fRec5[0] + -1.0f);
			fVec3[0] = fTemp4;
			float fTemp5 = float(iVec1[1]) * (fTemp4 - fVec3[1]);
			fVec4[IOTA0 & 4095] = fTemp5;
			fRec6[0] = fConst17 * fTemp2 + fConst16 * fRec6[1];
			float fTemp6 = float(input0[i0]) * (0.4f * float(input1[i0]) + 1.0f);
			fVec5[0] = fTemp6;
			fRec10[0] = -(fConst24 * (fConst23 * fRec10[1] - (fTemp6 + fVec5[1])));
			fRec9[0] = fRec10[0] - fConst22 * (fConst21 * fRec9[2] + fConst19 * fRec9[1]);
			float fTemp7 = fRec9[2] + fRec9[0] + 2.0f * fRec9[1];
			float fTemp8 = std::fabs(fConst22 * fTemp7);
			float fTemp9 = ((fTemp8 > fRec8[1]) ? fConst27 : fConst25);
			fRec8[0] = fTemp8 * (1.0f - fTemp9) + fRec8[1] * fTemp9;
			fRec7[0] = fConst28 * fRec7[1] - fConst29 * std::max<float>(2e+01f * std::log10(std::max<float>(1.1754944e-38f, fRec8[0])) + 1e+01f, 0.0f);
			float fTemp10 = ((iTemp0) ? 0.0f : fConst26 + fRec11[1]);
			fRec11[0] = fTemp10 - std::floor(fTemp10);
			float fTemp11 = 0.5f * (0.02f * ftbl0mydspSIG0[std::max<int>(0, std::min<int>(int(65536.0f * fRec11[0]), 65535))] + fConst22 * fTemp7 * std::pow(1e+01f, 0.05f * fRec7[0]) + 0.7f * fRec6[0] + fConst15 * (fTemp5 - fConst14 * fVec4[(IOTA0 - iConst10) & 4095] - fConst13 * fVec4[(IOTA0 - iConst11) & 4095]) + fConst6 * (fRec2[2] + fRec2[0] + 2.0f * fRec2[1]) + 0.05f * ftbl0mydspSIG0[std::max<int>(0, std::min<int>(int(65536.0f * fRec1[0]), 65535))]);
