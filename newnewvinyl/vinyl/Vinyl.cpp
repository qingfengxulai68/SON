...
struct mydsp : public dsp {
	...
	virtual void buildUserInterface(UI* ui_interface) {
		...
		ui_interface->addHorizontalSlider("dust", &fHslider2, FAUSTFLOAT(0.007f), FAUSTFLOAT(0.0f), FAUSTFLOAT(0.1f), FAUSTFLOAT(0.001f));
		...
		ui_interface->addHorizontalSlider("lowpass_freq", &fHslider6, FAUSTFLOAT(1e+03f), FAUSTFLOAT(1e+02f), FAUSTFLOAT(2e+04f), FAUSTFLOAT(1e+01f));
		ui_interface->addHorizontalSlider("motor_noise", &fHslider0, FAUSTFLOAT(0.3f), FAUSTFLOAT(0.0f), FAUSTFLOAT(0.5f), FAUSTFLOAT(0.01f));
	...
	virtual void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		float fSlow14 = 1.0f / ((fSlow12 + 1.0f) / fSlow10 + 1.0f);
		...
		for (int i0 = 0; i0 < count; i0 = i0 + 1) {
			...
			float fTemp8 = fTemp7 * (fSlow15 * fTemp7 + 1.0f);
			fVec4[0] = fTemp8;
			fRec14[0] = -(fSlow17 * (fSlow16 * fRec14[1] - (fTemp8 + fVec4[1])));
			fRec13[0] = fRec14[0] - fSlow14 * (fSlow13 * fRec13[2] + fSlow11 * fRec13[1]);
			float fTemp9 = fRec13[2] + fRec13[0] + 2.0f * fRec13[1];
			float fTemp10 = std::fabs(fSlow14 * fTemp9);
			float fTemp11 = ((fTemp10 > fRec12[1]) ? fSlow22 : fSlow20);
			fRec12[0] = fTemp10 * (1.0f - fTemp11) + fRec12[1] * fTemp11;
			fRec11[0] = fSlow23 * std::max<float>(2e+01f * std::log10(std::max<float>(1.1754944e-38f, fRec12[0])) - fSlow9, 0.0f) * fSlow8 + fSlow7 * fRec11[1];
			float fTemp12 = fSlow14 * fTemp9 * std::pow(1e+01f, 0.05f * fRec11[0]);
			fVec5[IOTA0 & 65535] = fTemp12;
			float fTemp13 = fSlow26 * (fTemp12 + fSlow25 * fVec5[(IOTA0 - iSlow24) & 65535] + fSlow3 * fRec10[0] + fSlow2 * (fTemp6 - fConst16 * fVec3[(IOTA0 - iConst12) & 4095] - fConst15 * fVec3[(IOTA0 - iConst13) & 4095]) + fConst7 * (fRec6[2] + fRec6[0] + 2.0f * fRec6[1]) + fSlow0 * (fRec3[0] + 0.5f * fRec0[0]));
